...
const root = process.env.SLIMEVR_SERVER_SOURCE || 'C:\\Users\\lag0m\\AppData\\Local\\Temp\\slimevr-server-reference';
const protocolRoot = path.join(root, 'solarxr-protocol');
