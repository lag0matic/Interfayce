...
{
    eSpeakerDevice,
    L"InterfayceTopologyFeed",                              // must match the INF interface name
    NULL,                                                   // optional template name
    CreateMiniportTopologySimpleAudioSample,
    &SpeakerTopoMiniportFilterDescriptor,
    0, NULL,                                                // Interface properties
    L"InterfayceWaveFeed",                                  // must match the INF interface name
    NULL,                                                   // optional template name
    CreateMiniportWaveRTSimpleAudioSample,
...
{
    eMicArrayDevice1,
    L"InterfayceTopologyMicrophone",        // must match the INF interface name
    NULL,                                   // optional template name
    CreateMicArrayMiniportTopology,
    &MicArray1TopoMiniportFilterDescriptor,
    0, NULL,                                // Interface properties
    L"InterfayceWaveMicrophone",            // must match the INF interface name
    NULL,                                   // optional template name
    CreateMiniportWaveRTSimpleAudioSample,
